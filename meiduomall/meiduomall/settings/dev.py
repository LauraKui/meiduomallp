...
DEFAULT_FILE_STORAGE = 'meiduomall.utils.fastdfs.fdfs_storage.Restorage'
...
HAYSTACK_CONNECTIONS = {
    'default': {
        ...
        'URL': 'http://192.168.110.132:9200/', # Elasticsearch服务器ip地址，端口号固定为9200
        'INDEX_NAME': 'meiduo_mall', # Elasticsearch建立的索引库的名称(名称可以随便取, 会自建)
    },
}
